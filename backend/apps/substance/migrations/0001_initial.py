# Generated by Django 4.0 on 2023-01-04 21:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_maintain",
                    models.DateTimeField(help_text="format: Y-m-d H:M:S", verbose_name="last maintain at"),
                ),
                (
                    "created_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("units", models.BigIntegerField(default=0, verbose_name="units available in stock")),
                (
                    "unit_type",
                    models.CharField(
                        choices=[("KILOGRAM", "KL"), ("LITER", "L"), ("TON", "T")],
                        max_length=20,
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="categories", to="substance.SubstanceCategory", verbose_name="substance Category"
                    ),
                ),
                (
                    "created_by",
