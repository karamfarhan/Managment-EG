    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("instruments", models.ManyToManyField(related_name="invoice", to="substance.InvoiceInstrumentItem")),
                (
                    "store",
                    models.ForeignKey(
                ...
                ("substances", models.ManyToManyField(related_name="invoice", to="substance.InvoiceSubstanceItem")),
            ],
            options={
